...
const products = [
  ...
  },
  {
    ...
    category: "s-monitoring",
    characteristics: [
      "For 134 ºC - 3,5 min / 121 ºC - 15 min Dimension: DIN A4 or DIN A5 size",
  ...
  },
  {
    ...
    refb: "REF: 103.240.0250 For Formaldehyde Unit: 250 indicators",
  ...
  },
  {
    ...
    category: "s-monitoring",
    characteristics: [
      "EO Integrator conform to ISO 11140 - Type 5 ",
      "Shelf life : 5 years after production",
  ...
  },
  {
    ...
    category: "s-monitoring",
    characteristics: [
      "Steam Integrator conform to ISO 11140 - Type 5 ",
      "Shelf life : 5 years after production",
      "Packed in an easy dispensing carton",
      "Non-Toxic / Lead Free",
  ...
  },
  {
    ...
    category: "s-monitoring",
    characteristics: [
      "Power supply range 90- 270 VAC / 50 – 60 Hz)",
  ...
  },
  {
    ...
    category: "s-monitoring",
    characteristics: [
      "Biological Indicator conform to ISO 11138 and ISO 11138-2 ",
  ...
  },
  {
    ...
    category: "trace",
    characteristics: [
      "Process Indicators (Steam, FO, EtO, Plasma) conform to ISO 11140 - 1 Type 1 ",
  ...
  },
  {
    ...
    category: "sbs",
    characteristics: [
      "Water repellent Microbial Barrier",
  ...
  },
  {
    ...
    category: "sbs",
    characteristics: [
      "EO Gas indicator conform to ISO 11140 - Type 1 ",
  ...
  },
  {
    ...
    category: "accs",
    characteristics: [
      "Produced in polypropylene , softening above 150°C",
  ...
  },
  {
    ...
    category: "accs",
    characteristics: [
      "Produced from 200 gr/sqm paper and high puncture resistant resin",
  ...
  },
  {
    ...
    category: "accs",
    characteristics: [
      "Produced from 200 gr/sqm paper",
  ...
  },
  {
    ...
    category: "accs",
    characteristics: [
      "Medical grade paper , 60 gram per square meter",
  ...
  },
  {
    ...
    category: "trace",
    characteristics: [
      "Double chemical indicator , one for steam and one for Ethylene Oxide ",
  ...
  },
  {
    ...
    category: "trace",
    characteristics: [
      "Single or double (piggy back) label material",
  ...
  },
  {
    ...
    category: "accs",
    characteristics: [
      "Easy to peel to the next sheet by tags on one of the corners",
  ...
  },
  {
    ...
    category: "accs",
    characteristics: [
      "20 mu quality makes the max. capacity up to 10 kilo of laundry",
  ...
  },
  {
    ...
    characteristics: [
      "Over 60 designs available (see page 2) ",
  ...
  },
  {
    ...
    category: "accs",
    characteristics: [
      "Flexible in design / usage / message (see second page for graphics) ",
...
const ProductsScreen = () => {
  ...
  'image1.jpg': require('../../assets/images/three.png'),
  'image2.jpg': require('../../assets/images/two.png'),
  'image3.jpg': require('../../assets/images/one.png'),
  // Diğer görselleri burada ekleyin
};
...
const renderProductItem = ({ item }: { item: ProductItem }) => (
  <TouchableOpacity style={styles.productCard}>
    <Image
      source={imageMap[item.image] || require('../../assets/images/arka.jpg')}
